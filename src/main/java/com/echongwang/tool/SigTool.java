...
public class SigTool {
     ...
     * @return 生成的签名
     */
    public static String getSignString(String app_id, String info, String app_key) throws UnsupportedEncodingException, NoSuchAlgorithmException, InvalidKeyException {
